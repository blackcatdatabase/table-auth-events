...
> Lineage: 1 outbound / 1 inbound · ✅ No engine drift detected · Index coverage: ready · PII flags: 5 · Changelog: fresh (0 d)
...
| Pkg folder | [packages\auth-events](https://github.com/blackcatacademy/blackcat-database/blob/main/packages\auth-events) | Repo location |
...
pwsh -NoLogo -NoProfile -File scripts/schema-tools/Migrate-DryRun.ps1 -Package auth-events -Apply
