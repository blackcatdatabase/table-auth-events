...
namespace BlackCat\Database\Packages\AuthEvents\Mapper;
...
/**
 * Bidirectional mapper between DB rows and DTO AuthEventDto:
...
final class AuthEventDtoMapper
{
     ...
     * @return AuthEventDto
     */
    public static function fromRow(array $row): AuthEventDto
    {
        /** @var AuthEventDto */
    ...
    public static function fromRowOrNull(?array $row): ?AuthEventDto
    {
     ...
     *
     * @param AuthEventDto   $dto
     * @param string[]|null   $onlyProps  optional whitelist of DTO properties to serialize
     * @return array<string,mixed>
     */
    public static function toRow(AuthEventDto $dto, ?array $onlyProps = null): array
    {
    ...
    public static function toRowNonNull(AuthEventDto $dto, ?array $onlyProps = null): array
    {
     ...
     * @return array<string,mixed>
     */
    public static function diff(AuthEventDto $dto, array $original, array $ignore = [], bool $coerce = true): array
    {
        $now = self::toRow($dto);
     ...
     * @return array<int,AuthEventDto>
     */
    public static function hydrateList(array $rows): array
    {
        /** @var array<int,AuthEventDto> */
    ...
    /** @return array<string,mixed> */
    public static function toSafeArray(AuthEventDto $dto): array
    {
        $row = self::toRow($dto);
     ...
     * @return \Generator<int,AuthEventDto>
     */
