...
use BlackCat\Database\Packages\AuthEvents\Repository\AuthEventRepositoryInterface;
use BlackCat\Database\Packages\AuthEvents\Repository\AuthEventRepository as GeneratedRepository;
...
{
  private AuthEventRepositoryInterface $repo;
  ...
  public function __construct(private Database $db)
  {
    ...
    public function _setRepositoryForTests(RepoContract $repo): void
    {
        ...
        if (!$repo instanceof AuthEventRepositoryInterface) {
            // Allow any repo that conforms to the interface even if not generated
            throw new \InvalidArgumentException('Expected AuthEventRepositoryInterface');
        }
        $this->repo = $repo;
    }
    ...
    public function getByUnique(array $keys, bool $asDto = false): array|\BlackCat\Database\Packages\AuthEvents\Dto\AuthEventDto|null { return $this->repo->getByUnique($keys, $asDto); }
    public function getById(int|string|array $id, bool $asDto = false): array|\BlackCat\Database\Packages\AuthEvents\Dto\AuthEventDto|null { return $this->repo->getById($id, $asDto); }
