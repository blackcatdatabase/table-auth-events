...
{
    private AuthEventRepository $repo;

    public function __construct(private Database $db)
    {
        $this->repo = new AuthEventRepository($db);
    }
    ...
    public function getByUnique(array $keys, bool $asDto = false): array|\BlackCat\Database\Packages\AuthEvents\Dto\AuthEventDto|null
    {
        return $this->repo->getByUnique($keys, $asDto);
    }

    /** @return array<string,mixed>|\BlackCat\Database\Packages\AuthEvents\Dto\AuthEventDto|null */
    public function getById(int|string|array $id, bool $asDto = false): array|\BlackCat\Database\Packages\AuthEvents\Dto\AuthEventDto|null
    {
