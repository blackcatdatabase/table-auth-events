 ...
 * - whitelist LIKE:   [ 'type', 'ip_hash_key_version', 'user_agent', 'meta_email' ]
 * Podporované tvary:
...
final class Criteria {
    ...
    public function toSql(bool $viewMode = false): array {
        ...
        $allowed = array_fill_keys([ 'id', 'user_id', 'type', 'ip_hash', 'ip_hash_key_version', 'user_agent', 'occurred_at', 'meta', 'meta_email' ], true);
        ...
        $order = null;
        if ($this->sort) {
            $safeCols = array_fill_keys([ 'id', 'user_id', 'type', 'ip_hash', 'ip_hash_key_version', 'user_agent', 'occurred_at', 'meta', 'meta_email' ], true);
            $parts = [];
