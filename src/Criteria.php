...
final class Criteria extends BaseCriteria
{
    ...
    {
        return [ 'id', 'user_id', 'type', 'ip_hash', 'ip_hash_key_version', 'user_agent', 'occurred_at', 'meta', 'meta_email' ];
    }
    ...
    {
        $x = [ 'id', 'user_id', 'type', 'ip_hash_key_version', 'user_agent', 'occurred_at', 'meta_email' ];
    ...
    public static function fromDb(
        ...
        if (\method_exists(\BlackCat\Database\Packages\AuthEvents\Definitions::class, 'softDeleteColumn')) {
            $soft = \BlackCat\Database\Packages\AuthEvents\Definitions::softDeleteColumn();
